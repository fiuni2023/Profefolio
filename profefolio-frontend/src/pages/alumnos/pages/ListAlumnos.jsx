    ...
    return (
        <>
            <MainContainer>
                ...
                <ModalAlumnos tituloModal={"Agregar Alumno"} isOpen={show} disabled={false} handleClose={()=>setShow(!show)}></ModalAlumnos>
                <ModalAlumnos selectedData={selectedStudent} tituloModal={"Detalles de alumno"} isOpen={showStudent} handleClose={()=>setShowStudent(!showStudent)}></ModalAlumnos>
